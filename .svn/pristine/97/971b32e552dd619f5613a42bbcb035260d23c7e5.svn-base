...
html, body {
	...
	width: 100%;
	height: 100%;
	background: url(img/bg_login.jpg) no-repeat center center scroll;
				...
				<div class="modal hide" id="myModal">
					...
					<div class="modal-body">
						<form method="post" id="login_form">
							<p>
								<input type="text" class="span3" name="id" placeholder="ID">
							</p>
							<p>
								<input type="password" class="span3" name="pw"
					...
					<div class="modal-footer" width="500px" height="1000px">
						Join the PentAcorn!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
							data-toggle="modal" href="#myModal02" class="btn btn-primary">Register</a>
					</div>
					</div>
					<div class="modal hide" id="myModal02">
						...
						<div class="modal-body" align="center">
							<form method="post" action='' name="login_form">
								<p>
									<input type="text" class="col-sm-3" name="name"
										placeholder="이름">
								</p>
								<input type="text" class="col-sm-1" name="eid" placeholder="ID">
								<input type="button" class="btn-default btn-sm" value="중복확인" />
								<p>
									<input type="text" class="col-sm-3" name="epw"
										placeholder="Password">
								</p>
								<p>
									<input type="password" class="col-sm-3" name="address"
										placeholder="주소">
								</p>
								<p>
									<input type="text" class="col-sm-3" name="mobile"
										placeholder="연락처">
								</p>
								<p>
