...
<html>
	...
	<form method="post">
		...
		마지막번호:<input name="endNum" size="1" value="${param.endNum}"/>
		간격:<input name="stepNum" size="1" value="${param.stepNum}"/><br>
		행:<input name="rowNum" size="1" value="${param.rowNum}"/>
		열:<input name="colNum" size="1" value="${param.colNum}"/><br>
