	...
	<center>
		...
		<form method="post">
			이름:<input type="text" name="ename" value="${emp.ename}" /> 직책:<input
				type="text" name="job" value="${emp.job}" /><br> 부서:<input
				type="checkbox" name="deptnos" value="10" />10 <input
				type="checkbox" name="deptnos" value="20" />20 <input
				type="checkbox" name="deptnos" value="30" />30 <input
				type="checkbox" name="deptnos" value="40" />40<br> <input
