...
<body>
	<center>
		<h2>EMP 상세</h2>
		<!-- springweb/emp_my.do?empno=7369 -->
		<form action="${path}/emp_upt.do" method="post">
			<table width="70%" border>

				<tr>
					<td width="50%">사원번호</td>
					<td><input type="hidden" name="empno" value="${emp.empno}" />
						${emp.empno}</td>
				</tr>
				<tr>
					<td>사원명</td>
				...
				<tr>
					<td>부서번호</td>
					<td><input type="text" name="deptno" value="${emp.deptno}" />
					</td>
				</tr>
				<tr>
					<td colspan="2"><input type="submit" value="수정" /> <input
						type="button" id="goList" value="메인화면" /></td>
				</tr>
			</table>
		</form>
</body>
