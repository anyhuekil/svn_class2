	...
	<div class="container-fluid">
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				<li class="active"><a href="intro.jsp" style="background: #222">HOME</a>
				</li>
			</ul>

			<ul class="nav navbar-nav navbar-right">
				<li style="margin: 12px; color: white;"><c:choose>
							...
							<div class="row">
								<div class="col-md-12">
									<form class="form" role="form" method="post"
										action="gameProcLogin.jsp" accept-charset="UTF-8"
										id="login-nav">
										<input type="hidden" id="hdLogin" name="hdPageChoice"
											value="login" />
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<form id="mainForm" method="post" action="gameProc.jsp">
				<input type="hidden" name="hdPageChoice" value="second" /> <input
					type="hidden" id="hdGameChoice" name="hdGameChoice" /> <input
					type="hidden" id="loserName" name="loserName" />
			</form>
