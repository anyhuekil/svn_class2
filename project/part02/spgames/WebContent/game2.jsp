...
<img src="./img/sol.jpg" alt="Image"
	style="height: 340px; float: left; margin-left: 34%;"
	id="iHitEverything">
<button type="button" name="udstart" id="udstart"
	class="btn btn-primary btn-block">Up and Down Game Start</button>
<br>
<input type="range" name="upDown" id="upDownvalue"
...
<br>
<button type="button" class="btn btn-primary btn-block" id="upDownSend">UP
	or DOWN</button>
