...
<body>
	...
	<br>
	<form method="post">
		<div class="col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4 col-xs-4 col-xs-offset-4 form-group">
			<div class="input-group">
				<div class="input-group-btn">
					<div class="col-xs-6 col-sm-3">
						<a class="btn btn-primary btn-select btn-select-light">
							<input type="hidden" class="btn-select-input" id="" name="" value="" />
							<span class="btn-select-value" data-width="100px" >검색 List</span>
					...
					<!-- /btn-group -->
					<div class="input-group-btn">
					<input type="text" name="hname" class="form-control" placeholder="경주마 정보 검색">
					</div>
