...
<body>
	...
	-->
		<input name="num01" value=<%=ranNum01[0] %>><input name="cal"
			value="+"><input name="num02" value=<%=ranNum02[0] %>>=<input
			name="sum"><br> <input name="num01"
			value=<%=ranNum01[1] %>><input name="cal" value="-"><input
			name="num02" value=<%=ranNum02[1] %>>=<input name="sum"><br>
		<input name="num01" value=<%=ranNum01[2] %>><input name="cal"
			value="*"><input name="num02" value=<%=ranNum02[2] %>>=<input
			name="sum"><br> <input name="num01"
			value=<%=ranNum01[3] %>><input name="cal" value="%"><input
			name="num02" value=<%=ranNum02[3] %>>=<input name="sum"><br>
		<input type="submit" value="전송">
	</form>
	<table border=1;>
		<%if(num01List!=null && calList!=null && num02List!=null && sumList!=null){%>
		<tr>
			<th><%=num01List[0]+calList[0]+num02List[0]%>=<%=sumList[0] %></th>
		...
		<tr>
			<th><%=num01List[1]+calList[1]+num02List[1]%>=<%=sumList[1] %></th>
		...
		<tr>
			<th><%=num01List[2]+calList[2]+num02List[2]%>=<%=sumList[2]  %></th>
		...
		<tr>
			<th><%=num01List[3]+calList[3]+num02List[3]%>=<%=sumList[3]  %></th>
