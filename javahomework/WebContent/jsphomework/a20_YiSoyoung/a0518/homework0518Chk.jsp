...
table{width:100%; background-color:#187025;}
caption{font-size: 1.5em; color:#187025; margin-bottom: 30px; border-bottom: #187025;background-color:white;}
td { padding:10px; text-align: center; background-color:white;}
td:FIRST-CHILD { width:100px;}
input[type=text] { border: 1px solid #187025;}
...
%>
	<div id="wrap">
		<table>
			...
			<tr><td>물건번호</td><td><%if(dto!=null) out.print(dto.getPno()); else out.print("결과없음");%></td></tr>
			<tr><td>물건명</td><td><%=searchpName %></td></tr>
			<tr><td>물건명</td><td><%if(dto!=null) out.print(dto.getPs());  else out.print("결과없음");%></td></tr>
			<tr><td colspan="2"><button onclick="location='homework0518.jsp'">앞으로</button>
		</table>
	</div>
</body>
</html>